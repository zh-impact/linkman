...
Provide a top-level Settings route reachable from the application header, hosting irreversible/dangerous operations behind a clearly marked danger zone.
## Requirements
