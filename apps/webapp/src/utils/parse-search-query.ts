 ...
 *
 * MIRRORS `apps/service/src/lib/url/parse-search-query.ts` — the two MUST
 * stay in sync. This project has no shared module between service and
 * webapp, so each app carries its own copy. If you change the grammar,
